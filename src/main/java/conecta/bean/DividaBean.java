   ...
   // @Inject
    ...
    public LazyDataModel<Divida> carregarDividas(){
       return listaDividaLazy = new LazyDataModel<Divida>() {
            ...
            public List<Divida> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
            ...
            try {
               ...
               // divida.setParcelas(listaParcelas);
                ...
                while(cont <= numPar) {
                    ...
                    parcela.setValor(divida.getValorTotal().divide(BigDecimal.valueOf((long)numPar), RoundingMode.HALF_UP));
    ...
    public void editar() {
        try {
            ...
            this.dividaRepository.excluir(this.divida);
            this.salvar();
